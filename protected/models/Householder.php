...
/**
 * This is the model class for table "{{householder}}".
 *
 * The followings are the available columns in table '{{householder}}':
 * @property integer $id
 ...
 */
class Householder extends CActiveRecord
{
	/**
	 ...
	 * @return Householder the static model class
	 */
