...
<body>
		...
		<div class="navbar-inner">
			<div class="container-fluid"><!--
				...
				<div class="btn-group pull-right">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <i
						class="icon-user"></i><span class="hidden-phone"> <?php 
								echo Yii::app()->user->name?>
					</span> <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<?php if (Yii::app()->user->isGuest) {	?>
							<li><a href="<?php echo Yii::app()->baseUrl;?>/user/login">ورود کاربر</a></li>
						<?php }else { ?>
							<li><a href="<?php echo Yii::app()->baseUrl;?>/user/profile">صفحه شخصی</a></li>
							<li class="divider"></li>
						<li><?php echo CHtml::link('خروج',array('/site/logout'));?></li>
						<?php  } ?>
	...
	<div class="container-fluid">
		...
		<footer>
			<p class="pull-left">
				<a href="http://khajehosseini.com" target="_blank">تولید</a> 1393
			</p>
			<p class="pull-right">
				اجرا کننده : <a href="http://khajehosseini.com">Khajehosseini.com</a>
			</p>
		</footer>
	</div>
	<!--/.fluid-container-->
